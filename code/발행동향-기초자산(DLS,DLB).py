...
payload = "<reqParam action=\"bassetTop10List\" task=\"ksd.safe.bip.cnts.DerivCombi.process.DeriDLSPTask\"><SECN_TPCD value=\""+num1+"\"/><DERI_INFO value=\"2\"/><STD_DT1 value=\""+date1+"\"/><STD_DT2 value=\""+date2+"\"/><START_PAGE value=\"1\"/><END_PAGE value=\"10\"/></reqParam>"
headers = {
